...
val Context.networkStatsManager: NetworkStatsManager
    @TargetApi(Build.VERSION_CODES.M) get() = systemServices[Context.NETWORK_STATS_SERVICE]
...
val Context.fingerprintManager: FingerprintManager
    @TargetApi(Build.VERSION_CODES.M) get() = systemServices[Context.FINGERPRINT_SERVICE]
...
val Context.telephonySubscriptionManager: SubscriptionManager
    @TargetApi(Build.VERSION_CODES.LOLLIPOP_MR1) get() = systemServices[Context.TELEPHONY_SUBSCRIPTION_SERVICE]

val Context.carrierConfigManager: CarrierConfigManager
    @TargetApi(Build.VERSION_CODES.M) get() = systemServices[Context.CARRIER_CONFIG_SERVICE]
...
val Context.usageStatsManager: UsageStatsManager
    @TargetApi(Build.VERSION_CODES.LOLLIPOP_MR1) get() = systemServices[Context.USAGE_STATS_SERVICE]
...
val BatteryManager.capacity: Int
	@TargetApi(Build.VERSION_CODES.LOLLIPOP) get() = getIntProperty(BatteryManager.BATTERY_PROPERTY_CAPACITY)

val BatteryManager.chargeCounter: Int
	@TargetApi(Build.VERSION_CODES.LOLLIPOP) get() = getIntProperty(BatteryManager.BATTERY_PROPERTY_CHARGE_COUNTER)

val BatteryManager.currentAverage: Int
	@TargetApi(Build.VERSION_CODES.LOLLIPOP) get() = getIntProperty(BatteryManager.BATTERY_PROPERTY_CURRENT_AVERAGE)

val BatteryManager.currentNow: Int
	@TargetApi(Build.VERSION_CODES.LOLLIPOP) get() = getIntProperty(BatteryManager.BATTERY_PROPERTY_CURRENT_NOW)

val BatteryManager.energyCounter: Long
	@TargetApi(Build.VERSION_CODES.LOLLIPOP) get() = getLongProperty(BatteryManager.BATTERY_PROPERTY_ENERGY_COUNTER)
