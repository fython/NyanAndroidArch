...
class LazyBindViewCreator<out T: View> internal constructor(private val id: Int) : ReadOnlyProperty<BaseActivity, T> {
...
class LazyBindNullableViewCreator<out T: View> internal constructor(private val id: Int) : ReadOnlyProperty<BaseActivity, T?> {
